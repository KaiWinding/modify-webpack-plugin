...
const isMatch = (str, reg) => !!str.match(reg)
const isNotMatch = (str, reg) => !!!str.match(reg)
  ...
  apply(compiler) {
    compiler.hooks.compilation.tap(PLUGIN_NAME, compilation => {
      ...
      compilation.hooks.buildModule.tap(PLUGIN_NAME, module => {
        ...
        const isMatchhaha = isMatchPath()

        if (isMatchhaha) module.addDependency(new TempDependency(module))
      })
    })
  }
}
